...
public class ItemDeadBoat extends Item
{
    private final EntityDeadBoat.Type type;

    public ItemDeadBoat(EntityDeadBoat.Type typeIn)
    {
        this.type = typeIn;
        this.maxStackSize = 1;
        this.setCreativeTab(HatedMobs.TAB);
        this.setUnlocalizedName("dead_boat");
        this.setRegistryName("dead_boat");
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                EntityDeadBoat entityboat = new EntityDeadBoat(worldIn, raytraceresult.hitVec.x, flag1 ? raytraceresult.hitVec.y - 0.12D : raytraceresult.hitVec.y, raytraceresult.hitVec.z);
