package fr.uranoscopidae.hatedmobs.client.models;
...
public class ModelDeadBoat extends ModelBase implements IMultipassModel
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        EntityDeadBoat EntityDeadBoat = (EntityDeadBoat)entityIn;
        ...
        this.renderPaddle(EntityDeadBoat, 0, scale, limbSwing);
        this.renderPaddle(EntityDeadBoat, 1, scale, limbSwing);
    }
    ...
    protected void renderPaddle(EntityDeadBoat boat, int paddle, float scale, float limbSwing)
    {
