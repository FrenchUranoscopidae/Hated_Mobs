...
public class AdvancedModelRenderer extends RendererModel
{
    ...
    @Override
    public RendererModel func_217178_a(String partName, float offX, float offY, float offZ, int width, int height, int depth, float p_217178_8_, int p_217178_9_, int p_217178_10_)
    {
        // TODO: test
    ...
    /**
     * Sets the scale for this AdvancedRendererModel to be rendered at. (Performs a call to GlStateManager.scaled()).
     *
        ...
        if (!this.isHidden) {
            if (this.showModel) {
                ...
                if (this.rotateAngleZ != 0.0F) {
                    GlStateManager.rotated((float) Math.toDegrees(this.rotateAngleZ), 0.0F, 0.0F, 1.0F);
                }
                if (this.rotateAngleY != 0.0F) {
                    GlStateManager.rotated((float) Math.toDegrees(this.rotateAngleY), 0.0F, 1.0F, 0.0F);
                }
                if (this.rotateAngleX != 0.0F) {
                    GlStateManager.rotated((float) Math.toDegrees(this.rotateAngleX), 1.0F, 0.0F, 0.0F);
                }
